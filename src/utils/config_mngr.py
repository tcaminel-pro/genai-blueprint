...
class OmegaConfig(BaseModel):
    ...
    def get_import(self, key: str) -> Any:
        ...
        if ":" not in qualified_name:
            raise ValueError(f"Invalid format for '{key}'. Expected format: 'module.submodule:object_name'")
        ...
        try:
            ...
            raise AttributeError(f"Cannot find object '{object_name}' in module '{module_path}' for key '{key}': {e}")
