...
from src.ai_chains.deep_agents.coding_agent_example import CodingAgentExample
from src.ai_chains.deep_agents.research_agent_example import \
    ResearchAgentExample
from src.ai_core.deep_agents import (DeepAgentConfig, create_coding_deep_agent,
                                     create_research_deep_agent,
                                     deep_agent_factory, run_deep_agent)
from src.ai_extra.tools_langchain.web_search_tool import basic_web_search

# Page configuration
st.set_page_config(
    page_title="Deep Agents Demo",
    page_icon="🤖",
    layout="wide",
...
class DeepAgentDemo:
    ...
    def render_coding_config(self):
        ...
        st.session_state.project_path = st.text_input(
    ...
    def render_analysis_config(self):
        ...
        st.session_state.analysis_type = st.selectbox(
            "Analysis Type",
            ["Exploratory", "Statistical", "Predictive", "Descriptive"]
        )
        
        st.session_state.visualization = st.checkbox(
    ...
    def render_custom_config(self):
        ...
        st.session_state.enable_planning = st.checkbox(
            "Enable Planning Tool",
            value=True
        )
        
        st.session_state.enable_filesystem = st.checkbox(
            "Enable File System",
            value=True
        )
        ...
        st.session_state.custom_tools_json = st.text_area(
            ...
            value='[]',
            height=100,
            help="Array of tool definitions"
        )
    ...
    def create_research_agent(self):
        ...
        # Create the agent
        agent = create_research_deep_agent(
            search_tool=web_search,
            name="Interactive Research Agent",
            async_mode=True
        )
    ...
    def render_chat_interface(self):
        ...
        if not st.session_state.current_agent:
            ...
            with col1:
                ...
                st.write("Conduct comprehensive research on any topic with web search, note-taking, and report generation.")
