...
- Propose ready to use agentic GenAI demos, demonstrating notably:
  - ReAct and CodeAct Agents to connect different data sources
...
## Tutorial 
A nice explanation of the code has been automatically generated by Code2Tutorial.

It's available here: 
[Tutorial: genai-blueprint](https://code2tutorial.com/tutorial/d4f58807-1657-41e1-92b8-15a3a10cb162/index.md) 

Have a look at it ! (note: it might be a little bit outdated)
